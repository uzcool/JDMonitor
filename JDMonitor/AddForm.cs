...
public class AddForm:XtraForm
{
    ...
    public AddForm(WebView2 browser):this()
    {
        _browser = browser;
    }
    ...
    private bool Check()
    {
        ...
        if (_browser != null && string.IsNullOrEmpty(txtTitle.Text))
        {
            _browser.CoreWebView2.Navigate(txtUrl.Text);
            txtTitle.Text = _browser.CoreWebView2.DocumentTitle;
        }
